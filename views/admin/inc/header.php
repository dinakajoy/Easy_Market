...
<header>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top justify-content-center">
    <a class="navbar-brand" href="admin-dashboard">Sellers Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExample04">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="admin-dashboard">Home <span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="admin-viewProducts">My Products</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="admin-addProduct">Add Products</a>
        </li>
      </ul>
